...
function CatalogoContent() {
  ...
  // SEO: Determinar contenido visible según categoría activa
  const categoriaParam = searchParams.get('categoria');
  const seoData = categoriaParam && seoCategorias[categoriaParam]
    ? seoCategorias[categoriaParam]
    : catalogoDefaultSEO;
                        ...
                        >
                          <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-muted to-muted/50 p-4">
                            <Image
                              ...
                              className="object-contain rounded-xl group-hover:scale-105 transition-transform duration-500 p-4"
                            />
